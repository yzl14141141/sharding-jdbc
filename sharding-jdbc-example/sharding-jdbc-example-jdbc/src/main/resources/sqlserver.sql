...
--ds_0
IF OBJECT_ID('t_order_0', 'U') IS NOT NULL   DROP TABLE t_order_0;
IF OBJECT_ID('t_order_1', 'U') IS NOT NULL   DROP TABLE t_order_1;
IF OBJECT_ID('t_order_item_0', 'U') IS NOT NULL   DROP TABLE t_order_item_0;
IF OBJECT_ID('t_order_item_1', 'U') IS NOT NULL   DROP TABLE t_order_item_1;
