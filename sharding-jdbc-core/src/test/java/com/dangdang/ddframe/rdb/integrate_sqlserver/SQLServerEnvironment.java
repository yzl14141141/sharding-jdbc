...
public final class SQLServerEnvironment {
    ...
    public SQLServerEnvironment(final DatabaseType databaseType) {
        this.databaseType = databaseType;
        fillData();
    }

    private void fillData() {
        DRIVER_CLASS_NAME.put(DatabaseType.SQLServer, com.microsoft.sqlserver.jdbc.SQLServerDriver.class);
        URL.put(DatabaseType.SQLServer, "jdbc:sqlserver://192.168.1.104:1433;databaseName=%s");
        USERNAME.put(DatabaseType.SQLServer, "ppdai");
        PASSWORD.put(DatabaseType.SQLServer, "Password");
    }
