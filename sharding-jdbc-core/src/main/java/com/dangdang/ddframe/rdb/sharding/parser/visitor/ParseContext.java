...
public final class ParseContext {
    ...
    private Map<Object, List<ParseTask>> parseTasks = new HashMap<>();
...
//    public void addParseTask(Object key, ParseTask task) {
//        List<ParseTask> taskList = this.parseTasks.get(key);
//        if (null == taskList) {
//            taskList = new ArrayList<ParseTask>();
//            this.parseTasks.put(key, taskList);
//        }
//        taskList.add(task);
//    }
//
//    public Optional<List<ParseTask>> getParseTasks(Object key) {
//        List<ParseTask> taskList = this.parseTasks.get(key);
//        return Optional.fromNullable(taskList);
//    }
